...
/**
 * DPoP helper functions kept dependency-light for reuse across modules.
 *
...
fun validateProofBasics(dpopJwt: String?,
    ...
    val normalizedHtu: String = normalizeUri(httpTokenUri)
    val normalizedRequest: String = normalizeUri(requestUri)
...
private fun normalizeUri(baseUri: String): String {
    ...
    val portPart: String = if (isPortSpecified(uri, scheme)) {
        ":${uri.port}"
    } else ""
