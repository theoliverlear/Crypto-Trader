package org.cryptotrader.api.library.entity.training;
...
import org.cryptotrader.api.library.entity.prediction.ModelType;
...
import org.cryptotrader.api.library.entity.training.specs.QueryLoad;
import org.cryptotrader.api.library.entity.training.specs.TrainingDevice;
import org.cryptotrader.api.library.entity.training.specs.TrainingQueryType;
...
public class TrainingSession extends Identifiable {
    ...
    public static TrainingSessionBuilder builder() {
        throw new IllegalStateException("Use TrainingSession.builder(PricePredictionLookup) from the application module.");
    }
